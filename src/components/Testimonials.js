   ...
   function supriseHandler(){
    ...
    return (
        <div className="w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-md">
            ...
            <div className="mt-6">
                <button onClick={supriseHandler} className='bg-violet-400 hover:bg-violet-500 transition-all duration-200 cursor-pointr px-10 py-2 rounded-md font-bold text-white text-lg'>
                    Surprise Me
                </button>
            </div>
